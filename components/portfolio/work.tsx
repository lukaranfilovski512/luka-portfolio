...
import { ArrowUpRight, Grid3X3, Images, X } from "lucide-react"
import { Reveal, SectionLabel } from "./reveal"
import { cn } from "@/lib/utils"
import { portfolioProjects, type PortfolioProject } from "@/lib/portfolio-projects"

type Category = "All" | "Social Media" | "Branding" | "Logo Design" | "Posters"

const filters: Category[] = ["All", "Social Media", "Branding", "Logo Design", "Posters"]
...
function isPremiumStyleProject(project: PortfolioProject) {
          ...
          <Reveal delay={0.05}>
            <div>
              ...
              <p className="mt-4 max-w-2xl text-pretty text-muted-foreground">
                ...
                and presentation-based projects open in a larger premium presentation format for clearer viewing.
              </p>
            </div>
          </Reveal>
        ...
        <div className="relative border-b border-border p-5 sm:p-8 lg:p-10">
          ...
          <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="inline-flex w-fit items-center gap-2 rounded-full border border-border bg-background/40 px-4 py-2 text-sm text-muted-foreground">
              ...
              {project.count} portfolio visuals
            </div>
          </div>
        </div>
