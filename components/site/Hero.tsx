...
export function Hero() {
  ...
  return (
    <section id="top" ref={ref} className="relative flex min-h-[100svh] items-center overflow-hidden pb-16 pt-32 lg:pt-28">
      ...
      <div className="relative mx-auto w-full max-w-[1480px] px-5 sm:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12 xl:gap-16">
          ...
          <motion.div style={{ y: copyY, opacity: copyOpacity }} className="relative z-10">
            ...
            <motion.p {...fadeUp(1.15)} className="mt-7 max-w-xl text-pretty leading-relaxed text-white/60 sm:text-lg">
              {hero.subtitle}
            </motion.p>

            <motion.div {...fadeUp(1.3)} className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <MagneticButton className="block w-full sm:w-auto">
                <a
                  href="#contact"
                  className="group inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/14 bg-white/[0.02] px-7 py-4 text-sm font-semibold text-white backdrop-blur transition-colors duration-300 hover:border-[#c02528]/60 sm:w-auto"
                >
                  {hero.ctas.secondary}
            ...
            <motion.p {...fadeUp(1.42)} className="mt-8 max-w-xl text-sm leading-relaxed text-white/45">
              {hero.positioning}
            </motion.p>

            <motion.div {...fadeUp(1.55)} className="mt-8 flex flex-wrap items-center gap-3">
          ...
          >
            <div aria-hidden className="absolute -inset-7 rounded-[2.5rem] bg-[#c02528]/20 blur-[70px]" />
